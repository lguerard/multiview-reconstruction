...
@ImgLoaderIo( format = "spimreconstruction.lightsheet7", type = LightSheet7ImgLoader.class )
public class XmlIoLightSheet7ImgLoader implements XmlIoBasicImgLoader< LightSheet7ImgLoader >
{
	...
	@Override
	public Element toXml( final LightSheet7ImgLoader imgLoader, final File basePath )
	{
	...
	@Override
	public LightSheet7ImgLoader fromXml(
			...
			final AbstractSequenceDescription<?, ?, ?> sequenceDescription )
	{
		try
		{
			...
			return new LightSheet7ImgLoader( new File( path, masterFile ), imgFactory, sequenceDescription );
		}
