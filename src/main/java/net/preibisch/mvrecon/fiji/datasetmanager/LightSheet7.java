...
import net.preibisch.mvrecon.fiji.spimdata.imgloaders.LightSheet7ImgLoader;
...
public class LightSheet7 implements MultiViewDatasetDefinition
{
	...
	@Override
	public String getTitle() { return "Zeiss Lightsheet 7 Dataset Loader (Bioformats)"; }

	@Override
	public String getExtendedDescription()
	{
		return "This datset definition supports files saved by the Zeiss Lightsheet 7\n" +
	...
	public SpimData2 createDataset()
	{
		...
		final LightSheet7MetaData meta = new LightSheet7MetaData();
		...
		final ImgLoader imgLoader = new LightSheet7ImgLoader( cziFile, imgFactory, sequenceDescription );
		...
		if ( fixBioformats )
			LightSheet7MetaData.fixBioformats( spimData, cziFile, meta );
	 ...
	 */
	protected TimePoints createTimePoints( final LightSheet7MetaData meta )
	{
	...
	protected ImgFactory< ? extends NativeType< ? > > selectImgFactory( final LightSheet7MetaData meta )
	{
		long maxNumPixels = 0;
	...
	protected boolean showDialogs( final LightSheet7MetaData meta )
	{
		GenericDialog gd = new GenericDialog( "Lightsheet 7 Properties" );
	...
	{
		GenericDialogPlus gd = new GenericDialogPlus( "Define Lightsheet 7 Dataset" );
	...
	@Override
	public LightSheet7 newInstance() { return new LightSheet7(); }
	...
	public static void main( String[] args )
	{
		...
		SpimData2 sd = new LightSheet7().createDataset();
